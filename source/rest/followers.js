...
module.exports = function(db,req,res){
	...
	if(urlParts[3] !== 'undefined' && urlParts[3] !== '') {
		db.query('SELECT users.id, users.login,users.fullname FROM followings,users WHERE followings.maven_id=? \
			AND followings.follower_id = users.id',[urlParts[3]],function(err, records){
